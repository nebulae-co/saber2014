...
Además del ejercicio de investigación y el valor académico generado, se presentan algunos productos que agregan valor a la propuesta:
 ...
 - Un paquete de R donde se encuentran los datos depurados de las pruebas Saber 11 y Saber Pro. Organiza de manera sistemática más de 5 millones de datos, facilitando su manejo y análisis. Garantiza el acceso a los datos del ICFES a la comunidad académica internacional.
