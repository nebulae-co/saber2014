...
cluster_municipios <- municipios_50$MUNI_RESIDE %>% #nombres de los municipios
  ...
  apply(1, function(x){fun_distance(totales_por_municipio[[x[1]]], totales_por_municipio[[x[2]]])}) %>% #aplicar la función de distancias a todas las parejas posibles
  ...
  hclust("ward.D") %>% #agruparlo con el método de ward
  cutree(4) #formar 4 clases
